...
#Load Datasets
datasets = {
    "LTSM_OneDirection": [pd.read_csv('datasets/lstm1_dataset1.csv'),  pd.read_csv('datasets/lstm1_dataset2.csv'),  pd.read_csv('datasets/lstm1_dataset3.csv')],
    "LSTM_BiDirection": [pd.read_csv('datasets/lstm2_dataset1.csv'), pd.read_csv('datasets/lstm2_dataset2.csv'), pd.read_csv('datasets/lstm2_dataset3.csv')]
    }
