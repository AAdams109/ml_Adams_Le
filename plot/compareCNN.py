...
#Load Datasets
datasets = {
    "CNN_Conv2_Pool1": [pd.read_csv('datasets/cnn1_dataset1.csv'),  pd.read_csv('datasets/cnn1_dataset2.csv'),  pd.read_csv('datasets/cnn1_dataset3.csv')],
    "CNN_Conv3_Pool2": [pd.read_csv('datasets/cnn2_dataset1.csv'), pd.read_csv('datasets/cnn2_dataset2.csv'), pd.read_csv('datasets/cnn2_dataset3.csv')]
    }
